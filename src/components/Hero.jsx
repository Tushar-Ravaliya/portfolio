        ...
        <div className="w-full lg:w-full">
          <div className="flex flex-col items-center lg:items-center">
            ...
            <p className="my-2 max-w-xl py-6 font-light tracking-tighter text-center">
              ...
              robust and scalable web applications. As a dedicated fresher, I
              have honed my skills in front-end technologies like React, as well
              as back-end technologies like Node.js, MySQL, PostgreSQL, and
